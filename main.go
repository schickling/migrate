...
// import "github.com/schickling/migrate/migrate" for usage within Go.
package main
...
import (
	...
	"github.com/schickling/migrate/file"
	"github.com/schickling/migrate/migrate"
	"github.com/schickling/migrate/migrate/direction"
	pipep "github.com/schickling/migrate/pipe"
	"os"
	"strconv"
	"time"
)
